...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Inshort Movies",style: TextStyle(color: Colors.white),),
  ...
  Widget buildMovieSection(BuildContext context,
      {required String title, required List movies}) {
    return Padding(
